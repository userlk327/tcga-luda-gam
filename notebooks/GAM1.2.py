...
DATA_PATH = '/content/drive/MyDrive/luad_tcga_pan_can_atlas_2018_clinical_data.csv'

!pip install -q scikit-survival lifelines xgboost torch patsy matplotlib seaborn
